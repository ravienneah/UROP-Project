...
cx_met_lifetime <- cx_met_lifetime |>
  mutate(early_life_alc_use = (as.numeric(cx_met_lifetimeH1TO12 == "(1) (1) Yes")))
cx_met_lifetime$early_life_heavy_drinking <- cx_met_lifetime$H1TO17 |>
  fct_rev() |>
  as.numeric()
...
cx_met_lifetime$sud_losscontrol2 <- as.numeric(cx_met_lifetime$H4TO55 == "(1) (1) Yes")

#Have you ever tried to quit or cut down on your drinking?
#If Q54 = 0, 6, 8, ask Q55, else if Q54 = 1, skip to Q56.
cx_met_lifetime$sud_losscontrol3 <- as.numeric(cx_met_lifetime$H4TO54 == "(1) (1) Yes")

skiplogic54 <- cx_met_lifetime |>
  filter(!is.na(H4TO54)) |>
  mutate(sud_losscontrol3 = as.numeric(H4TO44))
